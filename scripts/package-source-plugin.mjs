...
Double-click Certify-UE5HTML5Exporter.cmd to build, install, run the native editor setup test, export, certify browser FPS plus advisory runtime-ready/frame pacing, and record combined Win64 evidence.`;
}
