...
Double-click Certify-UE5HTML5Exporter.cmd to build, install, run the native editor setup test, export, certify the browser FPS, and record combined Win64 evidence.`;
}
