...
$confirmation = [System.Windows.Forms.MessageBox]::Show(
    "This will build the Win64 plugin, back up any installed copy, install the new package, export $Map, and open the default browser to certify cold/warm asset loading plus FPS shooting, score, depletion, and respawn.`n`nKeep the browser open until it reports PASS.`n`nContinue?",
...
[System.Windows.Forms.MessageBox]::Show(
    "Win64 and browser FPS certification passed.`n`nEvidence: $reportPath",
