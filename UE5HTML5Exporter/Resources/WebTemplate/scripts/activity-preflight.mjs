...
export const REQUIRED_EXPORT_FILES = [
  ...
  'release-discord-activity-production.cmd',
  'release-discord-activity-production.command',
  'release-discord-activity-production.sh',
  'verify-discord-activity-release.cmd',
  'verify-discord-activity-release.command',
  'verify-discord-activity-release.sh',
  'scripts/Start-DiscordActivityRelease.ps1',
  'scripts/activity-release-assistant.mjs',
  'scripts/activity-release.mjs',
  'scripts/activity-release-receipt.mjs',
  'supabase/migrations/20260823011658_discord_activity_core.sql',
  'supabase/migrations/20260823011836_optimize_discord_activity_realtime_rls.sql',
  'supabase/migrations/20260823011940_restrict_discord_activity_service_role_privileges.sql',
  'supabase/migrations/20260823104152_discord_activity_live_certification.sql',
  'vercel.json',
  'package.json',
];
